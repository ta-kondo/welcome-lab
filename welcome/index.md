...
### 対象読者: イノベーションラボ参加メンバー
  ...
  * ##### Slackよく知らないよ って方は全部
  * ##### Slackね、はいはい って方は ■ が必読
  * ##### ラボ期待してます って方は特に ★ を

### 書ききれなかった情報

  * ### <a href="./sub.html" target="_blank">別紙の補足</a>

    初回ガイドには不要な情報を <a href="./sub.html" target="_blank">別紙に補足として</a> 纏めています。
...
* ### 環境設定
  ...
  <a href="https://slack.com/intl/ja-jp/help/categories/360000047906" target="_blank">Slackの公式ヘルプ: プロフィールと環境設定</a> が充実していますので、一通り目を通しておくと良いかもしれません。
...
---
  ...
  * #### 興味のあるチャンネルへご参加お願いします！
    ...
    参加方法は <a href="https://slack.com/intl/ja-jp/help/articles/205239967-%E3%83%81%E3%83%A3%E3%83%B3%E3%83%8D%E3%83%AB%E3%81%AB%E5%8F%82%E5%8A%A0%E3%81%99%E3%82%8B" target="_blank">公式ヘルプ: チャンネルに参加する</a> をご参考までに。

    * 特に興味ない...、アレ欲しい！ といった場合、是非チャンネルを自分で作成しましょう。

      チャンネル作成のあれこれは <a href="./sub.html#チャンネルの命名規則" target="_blank">別紙の補足</a> で少し触れます。
...
---
  ...
  * ガイド内容
    ...
    `初めてという人`も、グループチャット主体のLINEのようなもの、という理解でいいかと思います。
      ...
      * <a href="https://appllio.com/basic-knowledge-of-slack" target="_blank">Slackとは？ LINEユーザーなら3分で理解できる基礎知識</a>
